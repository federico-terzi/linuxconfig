...
**Important:** this setup should not be necessary because the driver for this card can be installed by checking the `Install third-party software for graphics and Wi-Fi hardware...` checkbox during the Xubuntu installation.
